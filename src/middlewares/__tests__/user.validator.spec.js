...
import { req1, req3, req4, req5, req6, req7 } from "./__mocks__";

describe("UserValidator", () => {
  let mockResponse, res, next;
  beforeEach(() => {
    mockResponse = () => {
      const res = {};
  ...
  describe("registrationInputs", () => {
    it("should return errors when input validation fails", () => {
      ...
      expect(
        res.json.calledWith({
          errors: ["Please provide password.", "Please provide country."]
        })
      ).to.be.true;
    });
    it("should return errors when input validation fails", () => {
  ...
  describe("validateUserInputs", () => {
    ...
    it("should return errors if password format is not met", () => {
      ...
      expect(
        res.json.calledWith({
          error:
            "Password should be atleast 8 characters long, 1 lowercase & uppercase, numeric and special character"
        })
      ).to.be.true;
    });
